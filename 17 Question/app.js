...
Q.17: Shrinking Guest List: Unfortunately, your new table won’t arrive in time, and you can only invite two guests. */
var guestnames = ["Kavish", "Taha", "Musaddiq", "Imran", "Faraz", "Usman", "Abbas"];
...
while (guestnames.length > 2) {
    var removeGuest = guestnames.pop();
    console.log("Sorry, ".concat(removeGuest, ", I can't invite you to the dinner."));
}
console.log();
guestnames.forEach(function (guestname) {
    console.log("Dear ".concat(guestname, ", You are still invited to the dinner tonight."));
});
