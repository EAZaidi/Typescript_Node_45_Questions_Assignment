...
value for the number of tracks, add that value to the album’s Object. Make at least one
...
const album1 = make_album("Abida Parveen", "Raqs-e-Bismil");
const album2 = make_album("Mehdi Hasan", "Mehdi Hasan Ghazals");
const album3 = make_album("Sajjad Ali", "Chief Saab");
